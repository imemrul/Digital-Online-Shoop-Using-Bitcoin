        ...
        <div id="slider1_container" style="visibility: hidden; position: relative; margin: 0 auto; width: 1140px; height: 442px; overflow: hidden;">
            ...
            overflow: hidden;">
                <div>
                    <img u="image" src2="<?=base_url()?>images/slider/01.jpg" />
                </div>
                <div>
                    <img u="image" src2="<?=base_url()?>images/slider/02.jpg" />
                </div>
                <div>
                    <img u="image" src2="<?=base_url()?>images/slider/03.jpg" />
                </div>
                <div>
                    <img u="image" src2="<?=base_url()?>images/slider/04.jpg" />
                </div>
            </div>
